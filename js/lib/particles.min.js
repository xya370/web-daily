"use strict";var canvas={},image={},requestId=0,startTime=0;
...
Particles.prototype={
	...
	_calculate:function(a){
		...
		var l=a.cols,n=a.rows;
		var m=parseInt(image.w/l),c=parseInt(image.h/n);
		var g,e;
		var k=0;
		for(var d=0;d<l;d++){
			for(var b=0;b<n;b++){
				...
				if(f[k]<=10){
					this.array.push({
						...
						ease:a.ease,ratioX:a.ratioX,ratioY:a.ratioY
					})
				}
			}
		}
	...
	var linear=function(e,a,g,f){
		...
		e/=f;return -g*e*(e-2)+a
	},easeOutQuad=function(e,a,g,f){
		e/=f;return -g*e*(e-2)+a
	},easeInCubic=function(e,a,g,f){
		e/=f;return g*e*e*e+a
